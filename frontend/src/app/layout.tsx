      ...
      <body suppressHydrationWarning className={`${inter.className} flex h-screen bg-background overflow-hidden`}>
        ...
        <aside className="w-64 border-r bg-card flex flex-col">
          ...
          <div className="p-4 border-t">
            <button className="flex items-center gap-3 px-3 py-2 text-sm font-medium w-full text-left rounded-md hover:bg-secondary text-muted-foreground transition-colors">
